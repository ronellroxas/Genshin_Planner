...
public class Character {
    ...
    private int rarity;
    private ArrayList<String> ascension_mats;
    private ArrayList<String> talent_mats;

    public Character(int char_image, String char_name, int weap_type, int element, int rarity, ArrayList<String> ascension_mats, ArrayList<String> talent_mats){
    ...
    public ArrayList<String> getAscension_mats() {
        return ascension_mats;
    }

    public ArrayList<String> getTalent_mats(){
        return  talent_mats;
    }
    ...
    public void setAscension_mats(ArrayList<String> ascension_mats){
        this.ascension_mats = ascension_mats;
    }

    public void setTalent_mats(ArrayList<String> talent_mats){
        this.talent_mats = talent_mats;
    }
}
